...
# Render page header
render_page_header("Idioms for Natural Speech", "🎯", "Learn and practice idioms to sound more like a native speaker")
...
if st.session_state.daily_content["idioms"]:
    ...
    st.info("📚 Using default idioms. Check sidebar to get fresh daily idioms from news.")
...
st.markdown("---")
st.markdown("### Practice Using Idioms")
